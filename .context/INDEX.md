...
| `decisions/NNN-*.md` | ADRs | — | 1200 each | — | When a decision is referenced |
| `protocols/_index.md` | Protocol catalogue | any | 800 | 2026-04-19 | Protocol work |
...
| `snapshots/fN-*.md` | Phase-closing snapshots | — | 1000 each | — | Post-phase retrospective |
